...
{
    public class HrmInitialOld2Controller : Controller
    {
        ...
        public HrmInitialOld2Controller(IDesigRepository desig, IDivisionRepository division, IDeptRepository dept, ISectRepository sect)
        {
            _desig = desig;
            _division = division;
            _dept = dept;
